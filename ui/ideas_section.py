...
| **Значимость (p<0.05)** | Статистическая значимость | Показывает, был ли всплеск оборотов после публикации идеи реальным или случайным. Если отклонение от нормы превышает ~2 стандартных отклонения (σ) хотя бы в один день окна, мы с 95%-й уверенностью говорим: «это не совпадение, идея действительно повлияла на торги». Без такой проверки любой случайный скачок объёма можно было бы ошибочно принять за эффект идеи |
